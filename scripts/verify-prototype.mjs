...
try{
 for(const width of [320,390,768,1024,1440]){
  for(const entry of manifest.pages){
   ...
   check(await page.locator('.v2-primary a:visible').count()===13,entry.id+' all header areas '+width);
