...
`.Codex/rules/` entra sozinho no contexto conforme o arquivo que você toca —
...
sessão. Ver [.Codex/README.md](.Codex/README.md).
...
Tag local `checkpoint/pre-bootstrap-Codex` (commit `f3f08cb`, o último antes
