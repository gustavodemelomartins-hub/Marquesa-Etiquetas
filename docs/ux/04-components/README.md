...
Padrão visual que aparece em mais de uma tela. Cada pasta guarda o papel do
...
acontece na trilha do React, na fase prevista do Master Plan.

O que já existe em React está em `docs/ui/COMPONENT-INVENTORY.md`.
