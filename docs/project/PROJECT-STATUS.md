...
| REV-002 | React de Revendedoras — convergência com o protótipo e acerto seguro (**ownership Codex; em andamento**) | `frontend/src/features/revendedoras/`, `frontend/src/features/maletas/`, `api/src/maletas-comandos.js` | arquitetura, contratos e testes focados implementados; falta validação integrada/local, comparação visual final e publicação DEV |
