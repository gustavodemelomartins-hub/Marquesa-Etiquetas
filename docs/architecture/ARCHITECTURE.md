...
Fluxo completo em [SYNC_ENGINE.md](../domains/SYNC_ENGINE.md); detalhes de API,
matching e limites em [NUVEMSHOP_INTEGRATION.md](../domains/NUVEMSHOP_INTEGRATION.md).
